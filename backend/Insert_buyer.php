...
$buyer->datecreated = date('Y-m-d H:i:s');

if($buyer->Insert_buyer()){
    echo '<script defer>';
...
{		
    ...
    $buyer->password = base64_encode($_POST['password']);
    $buyer->cPassword = base64_encode($_POST['confirm']);
    $insert = mysqli_query($db,"INSERT INTO 'Buyers'('username', 'email', 'Password', 'Password_ver') VALUES ('$user_name','$email', '$password', '$cPassword')");
